...
Next, lets write our own templates. If you are unfamiliar with ggplot2, check [Plotting distributions (ggplot2)](http://www.cookbook-r.com/Graphs/Plotting_distributions_(ggplot2)/).

```{r 'newTemplates'}
## Read templates written elsewhere. Otherwise knitr has problems.
source('templatesHist.R')

## Lets check the new templates
...
save(regions, annotation, densityTemplates, file = 'regionsTemp.Rdata')
